...
import UserChainbUserChainbTestsuit1 from './user/chainb/user.chainb.testsuit1';
...
export default {
    UserChainbUserChainbTestsuit1: load(UserChainbUserChainbTestsuit1, 'user.chainb.testsuit1'),
