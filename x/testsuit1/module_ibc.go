...
func (am AppModule) OnRecvPacket(
	...
	var modulePacketData types.Testsuit1PacketData
	...
	case *types.Testsuit1PacketData_IbcDataInfoPacket:
		packetAck, err := am.keeper.OnRecvIbcDataInfoPacket(ctx, modulePacket, *packet.IbcDataInfoPacket)
		if err != nil {
		...
		ctx.EventManager().EmitEvent(
			sdk.NewEvent(
				types.EventTypeIbcDataInfoPacket,
...
func (am AppModule) OnAcknowledgementPacket(
	...
	case *types.Testsuit1PacketData_IbcDataInfoPacket:
		err := am.keeper.OnAcknowledgementIbcDataInfoPacket(ctx, modulePacket, *packet.IbcDataInfoPacket, ack)
		if err != nil {
			return nil, err
		}
		eventType = types.EventTypeIbcDataInfoPacket
	default:
		errMsg := fmt.Sprintf("unrecognized %s packet type: %T", types.ModuleName, packet)
...
func (am AppModule) OnTimeoutPacket(
	...
	case *types.Testsuit1PacketData_IbcDataInfoPacket:
		err := am.keeper.OnTimeoutIbcDataInfoPacket(ctx, modulePacket, *packet.IbcDataInfoPacket)
		if err != nil {
			return nil, err
		}
	default:
